...
public sealed class OfficeAgentTools
{
    ...
    public const string SystemPromptGuidance = """
        ...
        - Only these verbs work on a deck: changeText, insert, format, insertTable, removeTable, insertTableRows, removeTableRows, insertTableColumns, removeTableColumns, insertImage, removeImage, insertShape, removeShape, comment, insertSlide, removeSlide, moveSlide, duplicateSlide. The others return "unsupported-operation" and nothing in the plan is applied.
