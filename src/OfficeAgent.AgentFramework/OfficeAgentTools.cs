...
public sealed class OfficeAgentTools
{
    ...
    public const string SystemPromptGuidance = """
        ...
        - Only these verbs work on a deck: changeText, insert, format, fill, copyStyles, clearStyles, insertTable, removeTable, insertTableRows, removeTableRows, insertTableColumns, removeTableColumns, insertImage, removeImage, insertShape, removeShape, insertMedia, comment, section, headerFooter, transition, animate, insertSlide, removeSlide, moveSlide, duplicateSlide. Only setProperty, revision and the Word-only anchors return "unsupported-operation".
